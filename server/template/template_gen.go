...
func filesIndexHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "files/index.html", size: 855, mode: os.FileMode(420), modTime: time.Unix(1476151981, 0)}
...
func filesLoginHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "files/login.html", size: 841, mode: os.FileMode(420), modTime: time.Unix(1476151981, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func filesLogoutHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "files/logout.html", size: 7, mode: os.FileMode(420), modTime: time.Unix(1476151981, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
